...
public class DragRigidbody : MonoBehaviour
{
	...
	public void HandleInputBegin (Vector3 screenPosition) // This is called when the player clicks on the object, and the object is dragged
	{
		...
		if (Physics.Raycast (ray, out hit, distance)) {
			if (hit.transform.gameObject.layer == LayerMask.NameToLayer ("Interactive")) {
				...
				playerController.lockAttack = true;
	...
	public void HandleInput (Vector3 screenPosition) // This is called when the player is dragging the object
	{
		if (jointTrans == null)
			return;
